...
func (d *Db) EmInsertEmpty(tip, name string) {
	...
	if err != nil {
		fmt.Println("Ошибка внесения пользователя для эмоджи ", err)
	}
}
